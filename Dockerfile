...
# E.g.: docker run --name=slvpn --net=host --privileged -d -e VPN_HOST="vpn.ams03.softlayer.com" -e VPN_PORT="443" -e VPN_USER="MyVPNUser" -e VPN_PASS="MyVPNPass" saintd/slvpn
